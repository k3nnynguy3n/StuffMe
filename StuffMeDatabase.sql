CREATE DATABASE IF NOT EXISTS MILESTONE3;
USE MILESTONE3; 
...
/* Recipe table */
CREATE TABLE MILESTONE3.RECIPE (
...
/* Comment table */
CREATE TABLE MILESTONE3.COMMENTS (
...
/* Ingredient table */
CREATE TABLE MILESTONE3.INGREDIENT (
...
/* Equipment table */
CREATE TABLE MILESTONE3.EQUIPMENT (
...
/* Supplies table */
CREATE TABLE MILESTONE3.SUPPLIES (
	RECIPE_ID char(11) NOT NULL,
    INGREDIENT_NAME varchar(50) NOT NULL, 
    EQUIPMENT_NAME varchar(50) NOT NULL, 
    FOREIGN KEY (RECIPE_ID) REFERENCES RECIPE(RECIPE_ID),
